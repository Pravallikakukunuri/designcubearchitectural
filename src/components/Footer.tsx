  ...
  <footer className="py-10 bg-foreground">
    <div className="container mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6">
      ...
      <div className="flex items-center gap-6 text-primary-foreground/70">
        ...
        <a href="https://instagram.com/design_cube_143" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 font-body text-xs hover:text-accent transition-colors">
          <Instagram className="w-3.5 h-3.5" /> @design_cube_143
        </a>
      </div>
